    ...
    <AuthLayout imageSide="right">
      <GlassCard className="w-full max-w-[420px] p-8 sm:p-10">
        ...
        >
          ...
          <p className="text-sm text-muted mt-2">Join CRUVO and start your luxury journey</p>
        </motion.div>
        ...
        <form className="mt-8 grid gap-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <InputField label="Phone Number" id="phone" type="tel" placeholder="+1 (555) 000-0000" />
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white/80 px-4 text-xs text-muted font-medium">or</span>
          </div>
        </div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full h-12 rounded-full border border-border bg-white text-sm font-semibold text-dark transition-all duration-300 hover:shadow-md cursor-pointer flex items-center justify-center gap-3"
        >
